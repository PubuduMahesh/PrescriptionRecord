...
public class EditPatient extends JInternalFrame {
    ...
    private void addField() {
        ...
        /*profile picture*/
        ProfilePicture profilePicture = new ProfilePicture(patientController);
    ...
    private void saveButtonAction() {
        bUpdatge.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                patientController.firePatientEditPerformed(e);
            }
        });
    }
    ...
    private void clearField() {
        ActionEvent e = new ActionEvent("clearProfilePicture", -1, null);
        patientController.fireClearEditPatientFieldPerformed(e);
        tID.setText("");
        tName.setText("");
        tNIC.setText("");
        tAddress.setText("");
    ...
    private void createPatientObject(){    	
    	patientController.registerPatientEditReverseListeners(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                int dialogResult = JOptionPane.showConfirmDialog(null, "Would You Like to Change Patient Detail?", "Warning", 0);
                if (dialogResult == JOptionPane.YES_OPTION) {
                    String profilePic = e.getSource().toString();
                    ...
                    savePatient(new Patient(id, name, nic, address, gender, status, birthday, telephone, medicalHistory, profilePic));
                }
            }
        });
