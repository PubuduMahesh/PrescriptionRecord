...
public class EditDosage extends JDialog {
	...
	private void enableAddButton() {
		if(tID.getText().length()>0 && tName.getText().length()>0 && tDosage.getText().length()>0 && 
	...
	private void disableAddButton(){
		bAdd.setEnabled(false);
		rbTablet.addActionListener(new RadioBtnActionListener());
		rbCapsules.addActionListener(new RadioBtnActionListener());
		rbDay.addActionListener(new RadioBtnActionListener());
		rbWeek.addActionListener(new RadioBtnActionListener());
		rbMonth.addActionListener(new RadioBtnActionListener());
		tName.getDocument().addDocumentListener(new SaveButtonTextFieldCondtion());
		tDosage.getDocument().addDocumentListener(new SaveButtonTextFieldCondtion());
		tID.getDocument().addDocumentListener(new SaveButtonTextFieldCondtion());
	}
}
