...
public class RemoveDoctor extends JInternalFrame{
	...
	private void setDoctorField(Doctor doctor){
        ...
        private void birthdayButtonAction(){
			...
			public void actionPerformed(ActionEvent e) {
				try {
					String selDate = new DatePicker((RemoveDoctor)(bBirthday.getParent().getParent().getParent().getParent())).setPickedDate();
        ...
        private void removeButtonDisabled(){
            ...
            new RmoveButtonTextFieldCondtion(tName);		
            new RmoveButtonTextFieldCondtion(tBirthday);	
            new RemoveButtonRadioButtonCondtion(rbMale);
            new RemoveButtonRadioButtonCondtion(rbFemale);
        }
        private class  RmoveButtonTextFieldCondtion{
		public RmoveButtonTextFieldCondtion (JTextField textField) {
	...
	private class RemoveButtonRadioButtonCondtion{
        ...
        private void removePatient(String regNumer){
		...
		try {
			sql = "DELETE FROM `doctor` WHERE `doctor`.`regNumber` = '"+regNumer+"'";
			stmt.executeUpdate(sql);
			connection.close();
			setFieldClear();
			ActionEvent e1 = new ActionEvent(regNumer,-1,"");
